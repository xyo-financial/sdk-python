...
@pytest.fixture
def mock_enrichment_response_json() -> dict[str, Any]:
    return {
...
@pytest.fixture
def mock_batch_response_json() -> dict[str, Any]:
    return {
        "id": "batch_job_12345",
...
@pytest.fixture
def mock_status_response_json() -> dict[str, Any]:
    return {
        "status": "READY",
    }


def create_mock_tar_gz(entries: list[tuple[str, dict[str, Any] | str]]) -> bytes:
